...
<div class="p-6">
    ...
    <div class="bg-white shadow-lg rounded-2xl p-6 mb-8 border border-gray-200">
        ...
        <form action="{{ route('laporan-debit.check') }}" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
    ...
    <div class="bg-white rounded-2xl shadow-lg p-6 border border-gray-200">
        ...
        <div class="flex gap-2 mb-6">
            <form action="{{ route('laporan.debit.export') }}" method="GET" target="_blank">
            ...
            <table class="w-full text-sm border border-gray-200 rounded-lg overflow-hidden">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-4 py-2 font-semibold text-red-600 border">
                            Rp {{ number_format($hasil->nominal, 0, ',', '.') }}
                        </td>
                        <td class="px-4 py-2 border">{{ $hasil->description }}</td>
                        <td class="px-4 py-2 border">{{ $hasil->debit_date }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>

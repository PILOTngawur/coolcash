<div x-data="{ userMenu: false }" class="bg-gradient-to-r from-teal-400 to-blue-500 h-16 flex justify-between items-center px-6 text-white">
    <!-- Left: Sidebar Toggle -->
    <div class="flex items-center space-x-3">
        <button @click="open = !open" class="p-2 text-white rounded">

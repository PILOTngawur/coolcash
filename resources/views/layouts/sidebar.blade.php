    ...
    <ul class="space-y-5 p-3">
        ...
        <li x-data="{ open: false }">
            ...
            <ul x-show="open" x-transition class="pl-6 mt-2 space-y-1 text-gray-500">
                <li><a href="{{ route('categories_credit.index') }}" class="block hover:text-green-500">Kategori</a></li>
                <li><a href="{{ route('credit.index') }}" class="block hover:text-green-500">Uang Masuk</a></li>
            </ul>
        </li>

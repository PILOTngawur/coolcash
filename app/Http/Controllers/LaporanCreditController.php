...
use App\Models\Credit; // Corrected namespace
    ...
    public function export(Request $request)
{
    ...
    $credit = Credit::select('credit.id', 'credit.category_id', 'credit.user_id', 'credit.nominal', 'credit.credit_date', 'credit.description', 'categories_credit.name')
        ->join('categories_credit', 'credit.category_id', '=', 'categories_credit.id', 'LEFT')
        ->whereDate('credit.credit_date', '>=', $tanggal_awal)
        ->whereDate('credit.credit_date', '<=', $tanggal_akhir)
        ->get();

    return view('account.laporan_credit.export', compact('credit', 'tanggal_awal', 'tanggal_akhir'));
}
